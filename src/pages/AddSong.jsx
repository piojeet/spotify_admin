      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
        <div className='flex gap-8'>
          <div className='flex flex-col gap-4'>
            ...
            <label htmlFor="song" className='border border-gray-400 rounded-sm w-24 h-24 flex items-center justify-center'>
              <img src={song ? assets.Check_mark : assets.Upload_song} className='w-[60%] cursor-pointer' alt="" />
            </label>
          </div>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <label htmlFor="image" className='border border-gray-400 rounded-sm w-24 h-24'>
              <img src={image ? URL.createObjectURL(image) : assets.Upload_area} className='w-full h-full object-cover cursor-pointer' alt="" />
            </label>
          </div>
        </div>
